  ...
  return (
    <main className="p-8 max-w-3xl mx-auto space-y-8">
      ...
      <ul className="grid gap-4 sm:grid-cols-2">
        ...
        <li className="rounded-xl border p-4 hover:shadow-sm transition-shadow bg-white/60">
          <h2 className="font-medium mb-1"><Link href="/sheet_bend_visualizer_v_2_zoom_centers" className="hover:underline">Sheet Bend Visualizer (Zoom Centers)</Link></h2>
          <p className="text-xs text-muted-foreground">Visualize sheet bend rope paths with zoom center calculations.</p>
        </li>
      </ul>
